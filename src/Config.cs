...
static class Options
{
	...
	{
		BuddyFix.BuddyName = BuddyFix.Instance.Config.Bind(
		"General",
		"Best Buddy Name",
		"Best Buddy",
		"Change his name to whatever you want");
	...
	public static void RiskOfOptionsConfig() {
		const string MOD_GUID = BuddyFix.PluginGUID;
		const string MOD_NAME = BuddyFix.PluginName;

		ModSettingsManager.AddOption(new StringInputFieldOption(BuddyFix.BuddyName, true), MOD_GUID, MOD_NAME);
